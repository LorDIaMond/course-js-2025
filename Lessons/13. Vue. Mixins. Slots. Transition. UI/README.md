### Композиция логики: делим код на модули
...
В `<script setup>` мы можем выносить логику в отдельные модули для переиспользования и читаемости.
...
- **Зачем?** Упрощает поддержку и повторное использование кода.

***

### Кастомные хуки: своя магия

Кастомные хуки позволяют инкапсулировать логику.
...
- **Преимущество:** Логика становится переносимой.
...
#### Короткая запись именованных слотов
...
познакомиться **[здесь](https://vuejs.org/guide/built-ins/transition)**
